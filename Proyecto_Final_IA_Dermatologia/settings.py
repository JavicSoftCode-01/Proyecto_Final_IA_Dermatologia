...
SECRET_KEY = 'django-insecure-x+hb#da2=lf87z0fol@3pt8hxcm+g=dfc)tzciw7xv!llc3wxl'

# Configuración para Gemini AI
GEMINI_API_KEY = os.environ.get('GEMINI_API_KEY', 'AIzaSyDGgYUjyJKCpqAUDs9NXc-Dp0YFCuFOAGI')
